            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Notify when new documents are available</p>
                </div>
                <Switch
                  id="new-documents"
                  checked={settings.notifications.new_documents}
                  onCheckedChange={(checked) => updateNotificationSetting('new_documents', checked)}
                />
              </div>
            </CardContent>
          </Card>
